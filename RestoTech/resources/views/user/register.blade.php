                ...
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    <form method="POST" action="{{ route('registering') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" class="form-control form-control-lg fs-6" id="email" name="email" placeholder="Ingrese su email" >
                        </div>
                        @error('email')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-lg fs-6" placeholder="Contraseña">
                        </div>
